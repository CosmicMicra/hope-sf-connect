...
import ResourceTable from './food-resources/ResourceTable';
            ...
            >
              {resource.title === "Food Resources" ? (
                <Dialog>
                  ...
                  <DialogContent className="max-w-4xl w-full h-[90vh] overflow-hidden">
                    <DialogHeader>
                      <DialogTitle className="text-xl font-semibold">Available Food Resources</DialogTitle>
                    </DialogHeader>
